...
from Scripts.influxdbAPI import insertjson
from app import Task, NbackSettings, EyesSettings, IAPSSettings, Subject, db, PartOfGroup
...
def export_tasks_data(tasks_ids=[], filename="default", export_zip=False, export_csv=False):
    ...
    if export_csv:
        ...
        for id in tasks_ids:
            ...
            f.close()
            from Scripts.fixExcel import utf_to_windows
